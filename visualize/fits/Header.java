...
public class Header implements FitsElement {
     ...
     * @since 2005-10-24
     */
    public void updateLines(final Header newHdr) throws edu.caltech.ipac.visualize.fits.HeaderCardException {
    ...
    public void read(ArrayDataInput dis)
            throws TruncatedFileException, IOException {
        if (dis instanceof edu.caltech.ipac.visualize.fits.util.RandomAccess) {
