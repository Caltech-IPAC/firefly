...
public class RegionLoaderTest extends ConfigTest {
    ...
    public void testPositionAngle() {
        ...
        LOG.debug("" + VisUtil.getPositionAngle(new WorldPt(40.63917590447316, 42.56781951371009),
                new WorldPt(40.50254674815805, 42.66801248522869)));

        LOG.debug("" + VisUtil.getPositionAngle(new WorldPt(40.607766408497454, 42.57682008796501),
