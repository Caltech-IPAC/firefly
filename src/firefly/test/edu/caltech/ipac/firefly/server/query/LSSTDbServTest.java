...
public class LSSTDbServTest extends ConfigTest {
	...
	private static String [] queries = {
			...
			"SELECT * FROM DS_wise.wise_00.allwise_p3am_cdd WHERE scisql_s2PtInCPoly(9.462, -1.152, ra1, dec1, ra2, dec2, ra3, dec3, ra4, dec4)=1",
			...
			"SELECT * FROM DS_wise.wise_00.allsky_2band_p1bm_frm WHERE " +
