 ...
 * inputs:
 * @param xl l in degrees
 * @param xb b in degrees.
 ...
 *
 */
export function galeqd( xl, xb) {


   var rad, decd;
   var xlr,xbr,cosb,cosl,sinl,x,y,z,sind,
       cosd,decr,rar,eq2,eq3,cosa,sina;
   var cosph,sinph,cosps,sinps,costh,sinth;
   var psi=-33.0, theta=62.6, phi=282.25;
 ...
 *
 * inputs: 
 * @param rad ra in degrees, 
 * @param decd is dec in degrees.
 * @return {{ra: number, dec: number}}
 * b = galactic latitude (-90. to + 90. deg);l=galactic longitude(0-360)
 *
 ...
 *
 */
export function equgad( rad, decd) {
   var xl, xb;
   var rar,decr,cosa,sina,cosd,x,y,z,cosb,
 ...
 *
 * inputs: 
 * @param rad =  gal lon (l) in degrees. double precision.
 * @param decd = gal lat (b) in degrees. double precision.
 * @return {{ra: number, dec: number}}
 * returned:
 ...
 *
 */
export function galsgl(rad, decd) {

   var xl, xb;
   var rar,decr,cosa,sina,cosd,x,y,z,cosb, sinb,eq2,eq3,xbr,xlr,cosl,sinl;
   var cosph,sinph,cosps,sinps,costh,sinth;
   var psi= 0.0, theta = 83.68, phi = 137.37;
 ...
 *
 * inputs:
 * @param xb = supergalactic latitude  (SGB)  (-90. to + 90. deg). double precision.
 * @param xl = supergalactic longitude (SGL)  (0-360. deg). double precision.
 * @return {{ra: (number), dec: (number)}}
