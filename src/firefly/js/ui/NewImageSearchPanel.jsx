         ...
         <div >
           ...
           <div  className = 'OptionPanels' >
             <RadioGroupInputField
              ...
              labelStyle = {{paddingLeft: 0, paddingRight: 80}}
    ...
    return (
        <div >
            ...
            <RadioGroupInputField
                ...
                labelStyle = {{paddingLeft: 0, paddingRight: 70}}
                groupKey={groupKey}/>
          </div>
        </div>
    );
...
function getCatalogSelectView (groupKey, imageMasterData, imageSource){
    var sourcePanel;
    switch (imageSource) {
        case 'irsa':
...
function renderSingleColor(groupKey, imageMasterData, imageSource){
    ...
    var sourcePanel =getCatalogSelectView (groupKey, imageMasterData, imageSource);
        ...
        return (
            <Tab name= {rgb[index]} id={rgbFieldGroup[index]}  >
                ...
                <FieldGroup groupKey={rgbFieldGroup[index]} reducerFunc={ImageSelPanelChangeOneColor}
                            keepState={true}>
                    <ImageSourceOptionPanel groupKey={rgbFieldGroup[index]}/>
                    {getCatalogSelectView (rgbFieldGroup[index],imageMasterData, imageSource)}
                </FieldGroup>
