...
// the footprint's stored state for this plot
function getFootprintState(drawLayerId, plotId) {
...
export function FootprintToolUI({drawLayer, pv}) {
    ...
    const {hasData, currentPt, angle, angleUnit, angleFromUI, text, textLoc} =
        useStoreConnector(() => getFootprintState(drawLayerId, plotId), [drawLayerId, plotId]);
