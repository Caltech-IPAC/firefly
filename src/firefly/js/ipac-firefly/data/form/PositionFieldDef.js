...
var Vis= (function(retVis) {
    ...
    var makePositionFieldDef= function(properties) {
         ...
         *
         */
        var formatPosForTextField= function(wp) {
            var retval;
            try {
                var lon;
                var lat;
        ...
        var formatTargetForHelp= function(wp, name, resolver) {
            ...
            if (name && resolver) {
                ...
                if (retval ===null) {
                    retval = formatTargetForHelp(new ResolvedWorldPt(wp, name, resolver));
                }
            }
            else {
                name = wp.getObjName();
    ...
    if (hasModule) {
        exports.makePositionFieldDef= makePositionFieldDef;
    }


    retVis.makePositionFieldDef= makePositionFieldDef;
