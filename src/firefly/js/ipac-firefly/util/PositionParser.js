...
var Vis= (function(retVis) {
    ...
    var Pt= require("ipac-firefly/visualize/Pt.js");
     ...
     var makePositionParser = function(helper) {
        ...
        retPP.getPosition= function() {
            ...
            if (retPP.getInputType()===PositionParsedInput.Name) {
                ...
                wp = new Pt.WorldPt( retPP.getRa(), retPP.getDec(), retPP.getCoordSys());
            }
            return wp;
        };
    ...
    retVis.PositionParsedInput= PositionParsedInput;
    retVis.makePositionParser= makePositionParser;
