...
var Vis= (function(retVis) {
   ...
   */
  retVis.CoordUtil = function () {
    var DEFAULT_PRECISION = 8;
    var MAX_PRECISION = 8;
    var FORM_DECIMAL_DEGREE = 0;  // 12.34d
    var FORM_DMS = 1;             // 12d34m23.4s
    var FORM_HMS = 2;             // 12h34m23.4s

    var LAT_OUT_RANGE = "Latitude is out of range [-90.0, +90.0]";
    //var LON_OUT_RANGE = "Longitude is out of range [0.0, 360.0)";
    var LON_TOO_BIG = "Longitude is too big (>=360.0)";
    var LON_NEGATIVE = "Longitude can not be negative";
    var RA_TOO_BIG = "RA is too big (>=24 hours)";
    var INVALID_STRING = "Invalid Input";
    var HMS_FOR_LAT = "HMS notation not valid for latitude";
    var SEX_FOR_NONE_EQU = "Sexagesimal for non-Equatorial coordinate";
    var MIN_SEC_TOO_BIG = "Greater than 60 minutes or seconds";
    var INVALID_SEPARATOR = "Invalid input";
    //var EMPTY_STRING = "Empty input";
    ...
    var validLon = function (hms, coordSystem) {
      var retval= false;
      try {
        retval.convertStringToLon(hms, coordSystem);
        retval = true;
      } catch (e) {
        retval = false;
      }
...
//      buf += df.format(dangle);
    ...
    var retval= {};
    retval.convertLonToString=  convertLonToString;
    retval.convertLatToString = convertLatToString;
    retval.convertStringToLon = convertStringToLon;
    retval.convertStringToLat = convertStringToLat;
    retval.validLon           = validLon;
    //retval.validate = validate;

    if (hasModule) {
      exports.convertLonToString=  convertLonToString;
      exports.convertLatToString = convertLatToString;
      exports.convertStringToLon = convertStringToLon;
      exports.convertStringToLat = convertStringToLat;
      exports.validLon           = validLon;
