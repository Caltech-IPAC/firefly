 ...
 *
 * @prop {WebPlotParams} hipsRequestRoot a request object that contains the base parameter to display a HiPS
 * @prop {WebPlotParams} imageRequestRoot a request object that contains the base parameter to display an image. It must be a service type.
