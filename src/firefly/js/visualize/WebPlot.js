...
export function makeHiPSProjection(coordinateSys, lon=0, lat=0, fullSky= false) {
    const header= {
        ...
        // crpix1: fullSky ? HIPS_DATA_WIDTH : HIPS_DATA_WIDTH*.5,
...
export function isHiPSAitoff(plot) {
    if (!isHiPS(plot)) return false;
    return plot.projection.header.maptype===HIPS_AITOFF;
