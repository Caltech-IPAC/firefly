...
const baseUrl = 'https://irsadev.ipac.caltech.edu';
/**
...
export function makeShaPlotRequest(table, row, includeSingle,includeStandard) {
     ...
     */
    const serverinfo = 'https://irsadev.ipac.caltech.edu/data/SPITZER/';    //for test purpose
    //const shahost = 'https://sha.ipac.caltech.edu/'; //gwt sha host
