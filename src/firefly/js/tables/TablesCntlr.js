...
import {updateMerge, logError, logger} from '../util/WebUtil.js';
...
function reducer(state=initState(), action={}) {
    ...
    logger.isDebug() && get(action, 'type','').includes(DATA_PREFIX) && (logger.info(action.type + ': ' + get(action, 'payload.tbl_id')));
