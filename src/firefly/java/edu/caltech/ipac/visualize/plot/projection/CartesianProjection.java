...
public class CartesianProjection{
	...
	if (SUTDebug.isDebug())
	    System.out.println(
	    "RBH CartesianProjection.RevProject input lon = " + lon + 
	    "  lat = " + lat);
	*/

	result = ProjectionUtil.celestialToNative(lon, lat, glong, glat);
	if (result == null) {
	...
	*/
	...
	if (SUTDebug.isDebug())
	    System.out.println(
	    "RBH CartesianProjection.RevProject fsamp = " + fsamp + 
	    "  fline = " + fline);
	*/
	x = fsamp + crpix1 - 1;
	y = fline + crpix2 - 1;
	...
	{
	    System.out.println(
	    "RBH CartesianProjection.FwdProject: getProjectionName() returns "
	    + hdr.getProjectionName());
	    System.out.println(
	    "RBH CartesianProjection.FwdProject: input x = " + x + "  y = " + y);
	...
	*/
	...
	result = ProjectionUtil.nativeToCelestial(xx, yy, glong, glat);
	if (result == null) {
	...
	if (SUTDebug.isDebug())
	    System.out.println(
	    "RBH CartesianProjection.FwdProject: output lon = " + lon + 
	    "  lat = " + lat);
	*/
