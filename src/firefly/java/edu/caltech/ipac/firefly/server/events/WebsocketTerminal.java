...
public class WebsocketTerminal implements ServerEventQueue.EventTerminal {
    ...
    public void onOpen(final Session session) {
        ...
        try {
            ...
            ServerEvent connected = new ServerEvent(Name.EVT_CONN_EST, ServerEvent.Scope.CLIENT, "{\"termID\": \"" + session.getId() + "\", \"channel\": \"" + channelID + "\"}");
    ...
    public void onMessage(String message) {
        try {
            ...
            if (event.getTarget().getScope() == ServerEvent.Scope.CHANNEL ) {
                ...
                event.getTarget().setTermID(ServerEvent.SERVER_TERM_ID);
            }
