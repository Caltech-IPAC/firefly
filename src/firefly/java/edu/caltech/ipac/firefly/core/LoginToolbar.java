...
//        final String cookieUserKey = getCookieUserKey();
        ...
        GwtUtil.setStyles(user, "padding", "5px 5px", "textAlign", "right", "textOverflow", "ellipsis", "overflow", "hidden");
        ...
        GwtUtil.setStyles(signing, "padding", "5px 5px", "textAlign", "center");
