...
//    public final static String TABLE           = "table";
    ...
    public final static String NEOWISER_YR6 = "neowiser_yr6";       //this is the on-going yr6 internal neowiser
    ...
    private static HashMap<String, String[]> TABLE_MAP = new HashMap<String, String[]>(){
        {
            ...
            put(MERGE+"|1b-q", new String[]{"merge_p1bm_frm", "merge_q1bs_psd"});
