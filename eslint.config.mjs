...
export default [
    ...
    // vendored third-party source; never our code to fix
    {ignores: [
        "src/firefly/html/gpu-browser.min-*.js",
        "src/firefly/js/externalSource/**",
    ]},

    // eslint's own recommended rules; the block below layers over these
...

    {
        ...
        rules: {
            ...
            "jsdoc/require-param": 1,   // itemizing every param adds little; check-param-names still errors
