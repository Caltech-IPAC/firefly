...
/**
 * Created by IntelliJ IDEA. User: wmi Date: Sep 15, 2011 Time: 1:34:03 PM To change this template use File | Settings |
 * File Templates.
 */
...
public class PtfMOSRequest extends TableServerRequest {
    ...
    public String getObsBegin() {
        return getParam(OBS_BEGIN);
    }
    ...
    public String getObsEnd() {
        return getParam(OBS_END);
    }
    ...
    public String getEphemStep() {
        return getParam(EPHEM_STEP);
    }
    ...
    public String getSearchRegionSize() {
        return getParam(SEARCH_REGION_SIZE);
    }
