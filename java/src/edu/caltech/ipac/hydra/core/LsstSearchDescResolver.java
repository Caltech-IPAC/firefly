...
public class LsstSearchDescResolver extends SearchDescResolver implements SearchDescResolverCreator {

    public static final String ID = "lsst-" + WidgetFactory.SEARCH_DESC_RESOLVER_SUFFIX;
    ...
    public String getDesc(Request req) {
        ...
        if (cmd.equals("Hydra_lsst_lsst_coadd")) {
            return getPositionDesc(req);
        } else if (cmd.equals("Hydra_lsst_lsst_field")) {
            return getFieldDesc(req);
        } else if (cmd.equals("Hydra_lsst_lsst_most")) {
            return getSolarDesc(req);
        } else if (cmd.equals("Hydra_lsst_lsst_view")) {
...
//====================================================================
    ...
    private String getPositionDesc(Request req) {
        ...
        if (source == null) {
            ...
            //source = req.getParam(SimpleTargetPanel.POSITION_KEY);
        }
        return source + getSearchType(req) + getSearchRadius(req) + getFilterSelection(req) +
                getCutoutSize(req) + getDataProduct(req) + getImagesetSelection(req);
    }

    private String getFieldDesc(Request req) {
        String fieldId = req.getParam("lsstField");
    ...
    private String getFilterSelection(Request req) {
        String filter = req.getParam("filterName");
