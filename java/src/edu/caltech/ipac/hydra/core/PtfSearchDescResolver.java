 ...
 * @version
 */
public class PtfSearchDescResolver extends SearchDescResolver implements SearchDescResolverCreator {

    public static final String ID = "ptf-" + WidgetFactory.SEARCH_DESC_RESOLVER_SUFFIX;
