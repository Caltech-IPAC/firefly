package edu.caltech.ipac.hydra.ui.lsst;
 ...
 * @author Trey Roby
 */
public class LsstPlotTypeUI extends PlotTypeUI implements NeedsHub,
                                                          PlotRelatedPanel,
                                                          ThreeColorPreviewData.CanUpdatePreview {

    private static final WebClassProperties _prop = new WebClassProperties(LsstPlotTypeUI.class);

    public static final String FILTER_U = "filterU";
    public static final String FILTER_G = "filterG";
    public static final String FILTER_R = "filterR";
    public static final String FILTER_I = "filterI";
    public static final String FILTER_Z = "filterZ";
    ...
    public LsstPlotTypeUI(List<String> limitTableParam, List<String> argHeaders) {
    ...
    private Param getBandParam(String v) {
        Param retval = null;
        if (FILTER_U.equals(v)) {
            retval = new Param("filterName", "u");
        } else if (FILTER_G.equals(v)) {
            retval = new Param("filterName", "g");
        } else if (FILTER_R.equals(v)) {
            retval = new Param("filterName", "r");
        } else if (FILTER_I.equals(v)) {
            retval = new Param("filterName", "i");
        } else if (FILTER_Z.equals(v)) {
            retval = new Param("filterName", "z");
        }
        return retval;
    }
    ...
    public WebPlotRequest makeServerRequest(TablePanel table,
                                            Param wiseBandParam,
                                            TableData.Row<String> row) {
        ServerRequest sr = new ServerRequest("LsstFileRetrieve");
