...
public class CollapsiblePanelVisibilityEventWorkerCreator implements FormEventWorkerCreator {
    public FormEventWorker create(Map<String, String> params) {
        String masters = params.get("masters");
        String slaves = params.get("slaves");

        return new CollapsiblePanelVisibilityEventWorker(masters, slaves);
    }
}
