...
@SearchProcessorImpl(id = "planckImagesQuery3")
public class QueryPlanckImages3 extends DynQueryProcessor {

    private static final String PLANCK_FILE_PROP= "planck.filesystem_basepath";
    private static final String CUTOUTS_BASE_DIR= AppProperties.getProperty(PLANCK_FILE_PROP) + "/cutouts/psz1_cutouts/";
    ...
    protected File loadDynDataFile(TableServerRequest request) throws IOException, DataAccessException {
        ...
        String subdir = sname.substring(5,9);
