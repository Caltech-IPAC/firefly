...
/**
 * @author John Schimmels
 */
@SearchProcessorImpl(id = "2MassDownload")
public class TwoMassFileGroupsProcessor extends FileGroupsProcessor {
    ...
    private List<FileGroup> computeFileGroup(DownloadRequest request) throws IOException, IpacTableException, DataAccessException {
        // todo: process allBands url parameter
        logger.info("2Mass download option for 'allBands': " + request.getParam("allBands"));        
        ...
        for (int rowIdx : selectedRows) {
            ...
            FileInfo fi = new FileInfo(dataURL, filename, 0);
            fiArr.add(fi);
        }
