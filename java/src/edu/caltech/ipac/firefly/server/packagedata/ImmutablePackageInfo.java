 ...
 * @author Trey Roby
 */
class ImmutablePackageInfo implements PackageInfo, Serializable {
...
//======================================================================
    ...
    public ImmutablePackageInfo() { this(null,null,null,null, false); }

    public ImmutablePackageInfo(BackgroundReport report) { this(report,null,null,null,false); }

    public ImmutablePackageInfo(BackgroundReport report,
                                String email,
                                String baseFileName,
                                String title,
                                boolean canceled) {
