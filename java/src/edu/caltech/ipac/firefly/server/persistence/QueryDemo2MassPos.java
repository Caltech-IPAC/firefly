 ...
 *
 * @author Trey
 * @version $Id: QueryDemo2MassPos.java,v 1.10 2011/04/22 01:20:18 loi Exp $
 */
@SearchProcessorImpl(id = "DemoSearch2MassPos")
public class QueryDemo2MassPos extends IpacTablePartProcessor {

    private static final int MAX_ERROR_LEN = 200;
    private static final String TM_URL = "http://irsa.ipac.caltech.edu/cgi-bin/2MASS/IM/nph-im_sia?ds=asky&FORMAT=image/fits";
    private static final Logger.LoggerImpl _log = Logger.getLogger();
    private static String MAJ_TYPE = "catalog";
    ...
    public void prepareTableMeta(TableMeta meta, List<DataType> columns, ServerRequest request) {
        ...
        meta.setCenterCoordColumns(new TableMeta.LonLatColumns("center_ra", "center_dec", CoordinateSys.EQ_J2000));
    }
    ...
    private static DataGroup voToDataGroup(String doTable) throws Exception {
    ...
    private static void evaluateData(String errStr) throws IOException, EndUserException {
