...
* @author Trey Roby
*/
public class ImagePlotDefinition {
    ...
    private final List<List<String>> gridLayout; // null means auto

    public ImagePlotDefinition(String viewerID, List<String> drawingLayerList) {
        this.imageCount = 1;
    ...
    public ImagePlotDefinition(int imageCount,
     ...
     * @return
     */
    public List<List<String>> getGridLayout() {
        return gridLayout;
    }
