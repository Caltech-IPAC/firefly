...
public class BaseMonitorItem {
    ...
    private List<BaseMonitorItem> _groupMonitorList= null;
...
//======================================================================
    ...
    public BaseMonitorItem(String title, boolean watch) {
        this.title= title;
        this.watch= watch;
    }

    public BaseMonitorItem(String title) { this(title,true); }

    private BaseMonitorItem() { this(null,false); }
...
//======================================================================
    ...
    public void initStatusList(List<BackgroundStatus> partList) {
        if (_groupMonitorList==null) {
            _groupMonitorList= new ArrayList<BaseMonitorItem>(partList.size());
            BaseMonitorItem mi;
            for(BackgroundStatus status : partList) {
                mi= new BaseMonitorItem();
    ...
    public List<BaseMonitorItem> getCompositeList() {
    ...
    private void fireUpdate() {
        if (bgStatus!=null) {
            WebEvent<BaseMonitorItem> ev= new WebEvent<BaseMonitorItem>(this, Name.MONITOR_ITEM_UPDATE,
                                                                this);
    ...
    private static class DefaultCanceler implements CanCancel {
        ...
        private DefaultCanceler(BaseMonitorItem item) {
            _monItem= item;
