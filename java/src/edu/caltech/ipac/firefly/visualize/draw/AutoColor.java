...
public class AutoColor {
    ...
    public static final String SELECTED_PT = "AC-SEL-P";
    ...
    private static final String DEF_SELECTED_PT =  "00aaff";
    ...
    public String getSelectedPtColor() { return _ptSelected; }
