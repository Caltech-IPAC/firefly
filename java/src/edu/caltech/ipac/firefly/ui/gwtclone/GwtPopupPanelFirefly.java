...
/**
 * COPIED from GWT 2.2, based of ????? from gwt svn trunk
 *
...
public class GwtPopupPanelFirefly extends SimplePanel implements SourcesPopupEvents,
    EventPreview, HasAnimation, HasCloseHandlers<GwtPopupPanelFirefly> {

  /**
   * A callback that is used to set the position of a {@link GwtPopupPanelFirefly} right
   * before it is shown.
   */
  public interface PositionCallback {
     ...
     * @see GwtPopupPanelFirefly#setPopupPositionAndShow(PositionCallback)
     */
  ...
  static class ResizeAnimation extends Animation {
    /**
     * The {@link GwtPopupPanelFirefly} being affected.
     */
    private GwtPopupPanelFirefly curPanel = null;

    /**
     * Indicates whether or not the {@link GwtPopupPanelFirefly} is in the process of
    ...
    /**
     * The offset height and width of the current {@link GwtPopupPanelFirefly}.
     */
    ...
    private int animationDur= ANIMATION_DURATION;
     ...
     */
    public ResizeAnimation(GwtPopupPanelFirefly panel) {
      this.curPanel = panel;
    }
    ...
    public void setState(boolean showing, boolean isUnloading) {
      ...
      if (curPanel.animType != AnimationType.CENTER && !showing && !animateDown) {
        animate = false;
      }
      ...
      if (animate) {
        ...
        if (showing) {
          ...
          showTimer = new Timer() {
            ...
            public void run() {
              showTimer = null;
              ResizeAnimation.this.run(animationDur);
            }
          };
  ...
  /**
   * The {@link ResizeAnimation} used to open and close the {@link GwtPopupPanelFirefly}s.
   */
   ...
   *          changes.
   */
  public GwtPopupPanelFirefly(boolean autoHide) {
    this();
   ...
   */
  public GwtPopupPanelFirefly(boolean autoHide, boolean modal) {
    this(autoHide);
    this.modal = modal;
  }
  ...
  public HandlerRegistration addCloseHandler(CloseHandler<GwtPopupPanelFirefly> handler) {
  ...
  public void center() {
    ...
    if (!initiallyShowing) {
      ...
      if (initiallyAnimated) {
        ...
        setVisible(true);
        resizeAnimation.run(animationDur);
      } else {
        setVisible(true);
      }
    }
   ...
   *          {@link com.google.gwt.event.logical.shared.CloseHandler#onClose(com.google.gwt.event.logical.shared.CloseEvent)} when the popup is closed
   */
   ...
   * to actually attached/detach the {@link GwtPopupPanelFirefly} to the page.
   *
  ...
  /**
   * Get the glass element used by this {@link GwtPopupPanelFirefly}. The element is not
  ...
  /**
   * Enable or disable animation of the {@link GwtPopupPanelFirefly}.
   *
  ...
  public void setAnimationType(AnimationType type) {
    ...
    public void setAnimationDuration(int duration) {
        animationDur= duration;
        resizeAnimation.setAnimationDuration(duration);
    }

    public void setAnimateDown(boolean animateDown) {
        resizeAnimation.setAnimateDown(animateDown);
    }

    public boolean getAnimateDown() {
        return resizeAnimation.getAnimateDown();
    }
  ...
  /**
   * Get the element that {@link com.google.gwt.user.client.ui.impl.PopupImpl} uses. PopupImpl creates an element
   ...
   * itself.
   *
   * @return the Element that {@link com.google.gwt.user.client.ui.impl.PopupImpl} creates and expects
   */
  ...
  /**
   * Register or unregister the handlers used by {@link GwtPopupPanelFirefly}.
   */
