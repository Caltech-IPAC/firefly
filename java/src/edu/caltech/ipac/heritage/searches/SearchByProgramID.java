 ...
 *
 * @author loi
 * @version $Id: SearchByProgramID.java,v 1.10 2012/10/26 14:45:03 tatianag Exp $
 */
public class SearchByProgramID extends HeritageSearch<SearchByProgramID.Req> {

    public enum Type {AOR("aorByProgramID", DataType.AOR),
                      BCD("bcdByProgramID", DataType.BCD),
                      PBCD("pbcdByProgramID", DataType.PBCD),
    ...
    public SearchByProgramID(Type type, edu.caltech.ipac.firefly.data.Request clientReq) {
        super(type.dataType, type.dataType.getShortDesc(), new Req(type, clientReq),
                null, null);
    }

    public String getDownloadFilePrefix() {
        return "program" + getSearchRequest().getProgram() + "-";
    }
...
//====================================================================
    ...
    public static class Req extends HeritageRequest implements Serializable {
        public static final String PROGRAM = SearchByProgramCmd.PROGRAM_KEY;
