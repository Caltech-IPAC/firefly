...
public enum DataType implements DataEntry {
            ...
            SM("SIAP Super Mosaics", "Super Mosaics, created by combining together level 1 data from adjacent observations"),
            SOURCE_LIST("SIAP Source List", "Sources, extracted from enhanced images"),
