...
import edu.caltech.ipac.vamp.ui.previews.SpectralPreview;
 ...
 */
public class SimpleSpectralCreator implements ObsResultCreator {
    public TablePreview create(Map<String, String> params) {
        return new SpectralPreview("AVM Spectral Details");
    }
}
